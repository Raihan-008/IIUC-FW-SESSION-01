...
def calculate_compound_interest(principal, rate, times_compound, years):
    amount = principal * (1 + rate / times_compound) ** (times_compound * years)
    return amount

principal = float(input("Enter principal: "))
rate = float(input("Enter the annual interest rate (as a decimal): "))
times_compound = int(input("Enter the number of times interest is compounded per year: "))
years = float(input("Enter the investment period in years: "))

amount = calculate_compound_interest(principal, rate, times_compound, years)
