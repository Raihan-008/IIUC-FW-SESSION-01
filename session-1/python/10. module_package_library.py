...
from mypackage.module1 import greet_user # type: ignore
from mypackage.module2 import calculate_square # type: ignore

print(greet_user("Alice"))  # Should print: Hello, Alice! Welcome to our package.
print(calculate_square(4))  # Should print: 16
...
# Send a GET request to a public API (e.g., JSONPlaceholder)
